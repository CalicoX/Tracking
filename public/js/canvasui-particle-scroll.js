var CanvasUIParticleScroll = (() => {
  ...
  // components/canvasui/ParticleScrollEntry.ts
  var ParticleScrollEntry_exports = {};
  __export(ParticleScrollEntry_exports, {
    createParticleScroll: () => createParticleScroll,
    supportsHtmlInCanvas: () => supportsHtmlInCanvas
  });

  // components/canvasui/ParticleScrollVanilla.ts
  var DEFAULTS = {
    point: 0.68,
    band: 420,
    density: 2,
...
void main () {
  ...
  return __toCommonJS(ParticleScrollEntry_exports);
})();
