...
最后更新：2026-09-10（Features 左栏：`--feature-side-h`=最宽展开项+CTA，整块垂直居中；CTA 仍钉在这块底，不跟手风琴跑。不要锁满 `--feature-panel-h`，字会顶太高）
