...
- Split-order：主卡铺满右栏，内容左对齐；时间轴铺到右侧。邮件+两个包裹合成 **一张** 浮卡叠在主卡右上（`right:-8px`，跟 last-mile 电话同一套）。Park 黄框圈的是这一组，不要拆成三张卡。≤980 这张浮卡改静态放在主卡内容下面。
...
- 不要把图2 右侧邮件/包裹拆成三张独立卡（Park 黄框圈的是一整组）。
