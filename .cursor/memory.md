...
- Split / Branded 跟 last-mile 同一套：平躺 isometric，先聚拢再散开再铺平。图2/图3 落点垂直居中（不要 120px 贴底）。iso 等面板接近居中（c>0.52）再开始，不要一进场就铺平。点击切 tab 约 1.25s。
...
- Branded：表单+推荐卡+色盘，整组 max-width 540px 靠右、垂直居中。推荐卡叠表单右沿 -24px + 色盘 -10px。≤980 不叠。
