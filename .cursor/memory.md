...
最后更新：2026-08-24（Explore 去 3D hover；Returns 浮卡毛玻璃 + 产品场景底图）
...
- Explore 卡**不要 3D hover**。Returns 舞台底图 `public/assets/returns-scene.jpg`；两张浮卡（选商品 + Return method）毛玻璃 `backdrop-filter`。
