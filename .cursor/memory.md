...
- Split-order：跟 last-mile 同一套竖叠。邮件全宽在上（17TRACK / notify@17track.net，标题 Split into 2 packages），追踪卡在下（包裹 tab + 时间轴）。Package #1/#2 是主卡底部两行，不要右侧浮卡。Park 连续黄框圈的就是右侧那一组。
